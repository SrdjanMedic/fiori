		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#mynamespacemybrowseorders-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"mynamespacemybrowseorders-display": {
								"semanticObject": "mynamespacemybrowseorders",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=mynamespace.mybrowseorders",
									"url": sap.ui.require.toUrl("mynamespace/mybrowseorders")
								}
							}
						}
					}
